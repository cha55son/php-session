 ...
 *  @version    2.7.2 (last revision: April 07, 2012)
...
class Zebra_Database
{
     ...
     *  will result in using "disk" as caching method.</i>
     *
        ...
        if ($this->_connected()) {
            ...
            if ($cache !== false) {
                ...
                if ($this->caching_method == 'memcache') {
                    ...
                    if (($result = $this->memcache->get($memcache_key)) && $this->cached_results[] = @unserialize($result)) {
                ...
                if (is_resource($this->last_result) || $this->last_result === true) {
                    ...
                    if ($is_select && $cache !== false) {
                        ...
                        if ($this->caching_method == 'memcache')
                            ...
                            // cache query data
                            $this->memcache->set($memcache_key, serialize($cache_data), false, $cache);
     ...
     *                                  the actual results of the query!</i>
     */
    function select($columns, $table, $where = '', $replacements = '', $limit = '', $order = '', $cache = false, $highlight = false, $calc_rows = false)
    {
